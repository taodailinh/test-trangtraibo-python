...
import test_giaidoanbo.capnhatgiaidoan as giaidoanbo
import constants
...
for bo in client[db]["BoNhapTrai"].find({"SoTai":"BLUE2619"}):
    giaidoanbo.tinhgiaidoanbo(client,db,"2023-10-26",bo["SoTai"])
